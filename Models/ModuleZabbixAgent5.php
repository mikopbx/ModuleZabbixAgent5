...
class ModuleZabbixAgent5 extends ModulesModelsBase
{
     ...
     *
     * There is example to describe the relation between Providers and ModuleZabbixAgent5 models
     *
    ...
    public static function getDynamicRelations(&$calledModelObject): void
    {
        if (is_a($calledModelObject, Providers::class)) {
            $calledModelObject->belongsTo(
                'id',
                ModuleZabbixAgent5::class,
                'dropdown_field',
                [
                    'alias'      => 'ModuleZabbixAgent5Provider',
                    'foreignKey' => [
                        'allowNulls' => 0,
                        'message'    => 'Models\ModuleZabbixAgent5Provider',
